...
if (isset($_POST['submit'])) {
    ...
    if (file_exists($_FILES["primage"]["tmp_name"]) || is_uploaded_file($_FILES["primage"]["tmp_name"])) {
        ...
        if ($conn->exec($sqlinsertprod)) {
			...
			echo "<script>window.location.replace('../php/new_product.php')</script>";
            return;
        }
    } else {
...
{
    $target_dir = '/home8/doubleks/public_html/263547_lab_3_fairy_mart/images/';
...
<body>
	...
	<div class="main">
		...
		<div class="container">
			<form name="newProductForm" action="../php/new_product.php" onsubmit="return validateNewProductForm()" method="post" enctype="multipart/form-data">
			
			<div class="row" align="center">
			<img class="imgselection" src="/263547_lab_3_fairy_mart/images/photo.png"><br>
			...
			<div class="row">
				<div class="col-25">
					...
					<label for="prqty">Product Quantity (pack)</label>
				</div>
				<div class="col-75">
